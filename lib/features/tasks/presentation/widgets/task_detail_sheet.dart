                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        showTaskDetail(context, widget.dataService, task);
                      },
                    ),
                    IconButton(
                      ...
                      Row(
                        children: [
                          Checkbox(
                            ...
                            onChanged: (_) {
                              widget.dataService.toggleTaskCompletion(
                                taskId: task.id,
                    ...
                    children: [
                      ...
                      if (task.subtasks.isEmpty)
                        ...
                        ...task.subtasks.map((subtask) => CheckboxListTile(
                              ...
                              onChanged: (value) {
                                setState(() {
                                  final index = task.subtasks.indexOf(subtask);
                                  task.subtasks[index] = subtask.copyWith(isCompleted: value!);
                                });
                              },
                              title: Text(
                                subtask.title,
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              widget.dataService.deleteTask(widget.task.id);
